...
#define nrn_init _nrn_init__ichanWT2005
#define _nrn_initial _nrn_initial__ichanWT2005
#define nrn_cur _nrn_cur__ichanWT2005
#define _nrn_current _nrn_current__ichanWT2005
#define nrn_jacob _nrn_jacob__ichanWT2005
#define nrn_state _nrn_state__ichanWT2005
#define _net_receive _net_receive__ichanWT2005 
#define _f_trates _f_trates__ichanWT2005 
#define rates rates__ichanWT2005 
#define states states__ichanWT2005 
#define trates trates__ichanWT2005 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_ichanWT2005", _hoc_setdata,
 "rates_ichanWT2005", _hoc_rates,
 "states_ichanWT2005", _hoc_states,
 "trates_ichanWT2005", _hoc_trates,
 "vtrap_ichanWT2005", _hoc_vtrap,
 0, 0
};
#define vtrap vtrap_ichanWT2005
 extern double vtrap( double , double );
 /* declare global and static user variables */
#define usetable usetable_ichanWT2005
 double usetable = 1;
 /* some parameters have upper and lower limits */
 static HocParmLimits _hoc_parm_limits[] = {
 "usetable_ichanWT2005", 0, 1,
 0,0,0
};
 static HocParmUnits _hoc_parm_units[] = {
 "gnatbar_ichanWT2005", "mho/cm2",
 "gkfbar_ichanWT2005", "mho/cm2",
 "gl_ichanWT2005", "mho/cm2",
 "el_ichanWT2005", "mV",
 "gnat_ichanWT2005", "mho/cm2",
 "gkf_ichanWT2005", "mho/cm2",
 "inat_ichanWT2005", "mA/cm2",
 "il_ichanWT2005", "mA/cm2",
 "mtau_ichanWT2005", "ms",
 "htau_ichanWT2005", "ms",
 "stau_ichanWT2005", "ms",
 "nftau_ichanWT2005", "ms",
 0,0
};
 ...
 "usetable_ichanWT2005", &usetable_ichanWT2005,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 5, "kf_ion");
 	...
 	ivoc_help("help ?1 ichanWT2005 /home/adamgpeters/Levin/LevinWorkAdam/x86_64/ichanWT2005.mod\n");
...
static int _ode_count(int _type){ hoc_execerror("ichanWT2005", "cannot be used with CVODE"); return 0;}
 ...
 v=_v;
{
  ...
  ekf = _ion_ekf;
 { error =  states();
 if(error){fprintf(stderr,"at line 90 in file ichanWT2005.mod:\n    SOLVE states\n"); nrn_complain(_p); abort_run(error);}
 }  }}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/adamgpeters/Levin/LevinWorkAdam/ichanWT2005.mod";
static const char* nmodl_file_text = 
  ":\n"
  ":  ichanWT2005.mod \n"
  ":\n"
